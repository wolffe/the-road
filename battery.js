...
const batterySystem = {
    ...
    showSwapUI(foundBattery, entity) {
        ...
        panel.innerHTML =
            ...
            '<p style="margin:4px 0">Efficiency: ' + fontNumericHtml(Math.round(cur.efficiency * 100)) + '%</p></div>' +
            ...
            '<p style="color:' + ec + ';margin:4px 0">Efficiency: ' + fontNumericHtml(Math.round(fnd.efficiency * 100)) + '% ' + ea + '</p></div></div>' +
