...
const engineSystem = {
    ...
    showSwapUI(foundEngine, entity) {
        ...
        panel.innerHTML =
            ...
            '<p style="margin:4px 0">Power: ' + Math.round(cur.power * 100) + '%</p>' +
            '<p style="margin:4px 0">Fuel use: ' + Math.round(cur.fuelRate * 100) + '%</p>' +
            '</div>' +
            ...
            '<p style="color:' + pc + ';margin:4px 0">Power: ' + Math.round(fnd.power * 100) + '% ' + pa + '</p>' +
            '<p style="color:' + fc + ';margin:4px 0">Fuel use: ' + Math.round(fnd.fuelRate * 100) + '% ' + fa + '</p>' +
            '</div>' +
            '</div>' +
