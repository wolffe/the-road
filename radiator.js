...
const radiatorSystem = {
    ...
    showSwapUI(foundRadiator, entity) {
        ...
        panel.innerHTML =
            ...
            '<p style="margin:4px 0">Durability: ' + Math.round(cur.durability * 100) + '%</p></div>' +
            ...
            '<p style="color:' + dc + ';margin:4px 0">Durability: ' + Math.round(fnd.durability * 100) + '% ' + da + '</p></div></div>' +
